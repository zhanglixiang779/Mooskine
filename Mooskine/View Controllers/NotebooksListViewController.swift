...
//        updateEditButtonState()
    ...
    private func setupFetchedResultsController() {
        ...
        _ = ListDataSource<Notebook, NotebookCell>(tableView: tableView, managedObjectContext: dataController.viewContext, fetchRequest: fetchRequest) { (cell, notebook) in
            // Configure cell
    ...
    /// Adds a new notebook to the beginning of the `notebooks` array
